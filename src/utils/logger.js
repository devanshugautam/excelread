...
const { loggerConfig } = require('../../config/default.json');
...
const winstonOptions = {
    ...
    transports: [
        ...
        new winston.transports.DailyRotateFile({ filename: APP_ROOT + loggerConfig.folderName + loggerConfig.fileName + "-%DATE%.log", maxSize: loggerConfig.fileSize })
    ],
